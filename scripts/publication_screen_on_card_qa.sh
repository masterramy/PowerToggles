...
if grep -Eq 'NotificationRecord\(.*pkg=com\.ramybaheeg\.togglebay.*id=103|pkg=com\.ramybaheeg\.togglebay.*id=103' "$OUT/state/screen-on-disabled-notification.txt"; then
